...
from ansible.executor.stats import DictionaryStats
...
class TaskQueueManager:
    ...
    def __init__(self, inventory, variable_manager, loader, options, passwords, stdout_callback=None, run_additional_callbacks=True, run_tree=False):
        ...
        self._stats = DictionaryStats(options)  # Until a 'stats' module presents itself.. Also 'play_to_path_map' shouldn't have to be passed in.. oh well.
